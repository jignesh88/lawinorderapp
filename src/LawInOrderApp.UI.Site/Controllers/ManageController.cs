...
using System.Text;
using LawInOrderApp.Infra.CrossCutting.Identity.Extensions;
using LawInOrderApp.Infra.CrossCutting.Identity.Models;
using LawInOrderApp.Infra.CrossCutting.Identity.Services;
using LawInOrderApp.Infra.CrossCutting.Identity.Models.ManageViewModel;
    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("LawInOrder App Project"),
